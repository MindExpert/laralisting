            ...
            <div class="container mx-auto">
                <nav class="p-4 flex items-center justify-between">
                    ...
                    <div v-if="user" class="flex items-center gap-4">
                        ...
                        <Link class="text-sm text-gray-500" :href="route('realtors.listings.index')">{{ user.name }}</Link>
                        <Link :href="route('realtors.listings.create')" class="btn-primary">+ New Listing</Link>
                        <div>
