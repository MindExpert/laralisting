                ...
                <div class="flex flex-col md:flex-row gap-2 md:items-center justify-between">
                    ...
                    <section>
                        ...
                        >
                            ...
                            <Link
                                class="btn-outline text-xs font-medium"
                                :href="route('realtors.listings.edit', { listing: listing.id })"
                            >
                                Edit
                            </Link>
                            ...
                            <Link
                                ...
                                class="btn-outline text-xs font-medium"
                                :href="route('realtors.listings.destroy', { listing: listing.id })"
                            ...
                            <Link
                                ...
                                :href="route('realtors.listings.restore', { listing: listing.id })"
                        ...
                        <div class="mt-2">
                            <Link
                                :href="route('realtors.listings.image.create', { listing: listing.id })"
                        ...
                        <div class="mt-2">
                            <Link
                                :href="route('realtors.listings.show', { listing: listing.id })"
                                class="block w-full btn-outline text-xs font-medium text-center"
                            >
